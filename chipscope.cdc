...
Project.filter<0>=
Project.filter<10>=mem_control_inst
Project.filter<11>=*data_read*
Project.filter<12>=*data_read_en*
Project.filter<13>=data_read_en
Project.filter<14>=test_is_read
Project.filter<15>=*we*
Project.filter<16>=*oe*
Project.filter<17>=oe
Project.filter<1>=*micron_wait*
Project.filter<2>=micron_wait
Project.filter<3>=clk_50
Project.filter<4>=clk_25
Project.filter<5>=*bufg*
Project.filter<6>=*ce*
Project.filter<7>=*adv*
Project.filter<8>=*FFd3*
Project.filter<9>=mem_control_inst*
...
Project.unit<0>.triggerChannel<2><9>=led_1_OBUF
