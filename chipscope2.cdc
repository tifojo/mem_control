...
Project.filter<0>=
Project.filter<1>=*done*
Project.filter<2>=*data_read_reg*
Project.filter<3>=*data_write_reg*
Project.filter<4>=*test_data_write*
Project.filter<5>=test_data
Project.filter<6>=*addr_reg*
Project.filter<7>=*test_addr*
Project.filter<8>=*clk_50*
...
Project.unit<0>.dataPortWidth=97
