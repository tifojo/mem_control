...
Project.filter<0>=
Project.filter<10>=*adv*
Project.filter<11>=*FFd3*
Project.filter<12>=mem_control_inst*
Project.filter<13>=mem_control_inst
Project.filter<14>=*data_read*
Project.filter<15>=*data_read_en*
Project.filter<16>=data_read_en
Project.filter<17>=test_is_read
Project.filter<18>=*we*
Project.filter<1>=*valid*
Project.filter<2>=*wait*
Project.filter<3>=*wait_reg*
Project.filter<4>=*micron_wait*
Project.filter<5>=micron_wait
Project.filter<6>=clk_50
Project.filter<7>=clk_25
Project.filter<8>=*bufg*
Project.filter<9>=*ce*
...
Project.unit<0>.dataChannel<34>=mem_control_inst/adv_d0
Project.unit<0>.dataChannel<35>=mem_control_inst/adv_d1
Project.unit<0>.dataChannel<36>=mem_control_inst/CE_reg
...
Project.unit<0>.dataChannel<40>=mem_control_inst/state_reg_FSM_FFd3
Project.unit<0>.dataChannel<41>=mem_control_inst/read_data_valid
...
Project.unit<0>.triggerChannel<2><2>=mem_control_inst/adv_d0
Project.unit<0>.triggerChannel<2><3>=mem_control_inst/adv_d1
Project.unit<0>.triggerChannel<2><4>=mem_control_inst/CE_reg
...
Project.unit<0>.triggerChannel<2><9>=mem_control_inst/read_data_valid
Project.unit<0>.triggerChannel<3><0>=mem_control_inst/addr_reg<8>
Project.unit<0>.triggerChannel<3><10>=mem_control_inst/addr_reg<18>
Project.unit<0>.triggerChannel<3><11>=mem_control_inst/addr_reg<19>
Project.unit<0>.triggerChannel<3><12>=mem_control_inst/addr_reg<20>
Project.unit<0>.triggerChannel<3><13>=mem_control_inst/addr_reg<21>
Project.unit<0>.triggerChannel<3><14>=mem_control_inst/addr_reg<22>
Project.unit<0>.triggerChannel<3><1>=mem_control_inst/addr_reg<9>
Project.unit<0>.triggerChannel<3><2>=mem_control_inst/addr_reg<10>
Project.unit<0>.triggerChannel<3><3>=mem_control_inst/addr_reg<11>
Project.unit<0>.triggerChannel<3><4>=mem_control_inst/addr_reg<12>
Project.unit<0>.triggerChannel<3><5>=mem_control_inst/addr_reg<13>
Project.unit<0>.triggerChannel<3><6>=mem_control_inst/addr_reg<14>
Project.unit<0>.triggerChannel<3><7>=mem_control_inst/addr_reg<15>
Project.unit<0>.triggerChannel<3><8>=mem_control_inst/addr_reg<16>
Project.unit<0>.triggerChannel<3><9>=mem_control_inst/addr_reg<17>
...
Project.unit<0>.triggerPortWidth<3>=15
