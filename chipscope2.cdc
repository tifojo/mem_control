...
Project.filter<0>=
Project.filter<10>=*clk_50*
Project.filter<1>=*debug*
Project.filter<2>=*error_not*
Project.filter<3>=*done*
Project.filter<4>=*data_read_reg*
Project.filter<5>=*data_write_reg*
Project.filter<6>=*test_data_write*
Project.filter<7>=test_data
Project.filter<8>=*addr_reg*
Project.filter<9>=*test_addr*
...
Project.unit<0>.dataChannel<32>=test_data_write<0>
Project.unit<0>.dataChannel<33>=test_data_write<1>
Project.unit<0>.dataChannel<34>=test_data_write<2>
Project.unit<0>.dataChannel<35>=test_data_write<3>
Project.unit<0>.dataChannel<36>=test_data_write<4>
Project.unit<0>.dataChannel<37>=test_data_write<5>
Project.unit<0>.dataChannel<38>=test_data_write<6>
Project.unit<0>.dataChannel<39>=test_data_write<7>
Project.unit<0>.dataChannel<3>=test_address<10>
Project.unit<0>.dataChannel<40>=test_data_write<8>
Project.unit<0>.dataChannel<41>=test_data_write<9>
Project.unit<0>.dataChannel<42>=test_data_write<10>
Project.unit<0>.dataChannel<43>=test_data_write<11>
Project.unit<0>.dataChannel<44>=test_data_write<12>
Project.unit<0>.dataChannel<45>=test_data_write<13>
Project.unit<0>.dataChannel<46>=test_data_write<14>
Project.unit<0>.dataChannel<47>=test_data_write<15>
...
Project.unit<0>.dataChannel<97>=error_not0001
...
Project.unit<0>.triggerChannel<2><0>=test_data_write<0>
Project.unit<0>.triggerChannel<2><10>=test_data_write<10>
Project.unit<0>.triggerChannel<2><11>=test_data_write<11>
Project.unit<0>.triggerChannel<2><12>=test_data_write<12>
Project.unit<0>.triggerChannel<2><13>=test_data_write<13>
Project.unit<0>.triggerChannel<2><14>=test_data_write<14>
Project.unit<0>.triggerChannel<2><15>=test_data_write<15>
Project.unit<0>.triggerChannel<2><1>=test_data_write<1>
Project.unit<0>.triggerChannel<2><2>=test_data_write<2>
Project.unit<0>.triggerChannel<2><3>=test_data_write<3>
Project.unit<0>.triggerChannel<2><4>=test_data_write<4>
Project.unit<0>.triggerChannel<2><5>=test_data_write<5>
Project.unit<0>.triggerChannel<2><6>=test_data_write<6>
Project.unit<0>.triggerChannel<2><7>=test_data_write<7>
Project.unit<0>.triggerChannel<2><8>=test_data_write<8>
Project.unit<0>.triggerChannel<2><9>=test_data_write<9>
...
Project.unit<1>.clockChannel=clk_0
Project.unit<1>.clockEdge=Rising
Project.unit<1>.dataChannel<0>=mem_control_inst/debug_align
Project.unit<1>.dataChannel<10>=mem_control_inst/debug_0_reg<9>
Project.unit<1>.dataChannel<11>=mem_control_inst/debug_0_reg<10>
Project.unit<1>.dataChannel<12>=mem_control_inst/debug_0_reg<11>
Project.unit<1>.dataChannel<13>=mem_control_inst/debug_0_reg<12>
Project.unit<1>.dataChannel<14>=mem_control_inst/debug_0_reg<13>
Project.unit<1>.dataChannel<15>=mem_control_inst/debug_0_reg<14>
Project.unit<1>.dataChannel<16>=mem_control_inst/debug_0_reg<15>
Project.unit<1>.dataChannel<1>=mem_control_inst/debug_0_reg<0>
Project.unit<1>.dataChannel<2>=mem_control_inst/debug_0_reg<1>
Project.unit<1>.dataChannel<3>=mem_control_inst/debug_0_reg<2>
Project.unit<1>.dataChannel<4>=mem_control_inst/debug_0_reg<3>
Project.unit<1>.dataChannel<5>=mem_control_inst/debug_0_reg<4>
Project.unit<1>.dataChannel<6>=mem_control_inst/debug_0_reg<5>
Project.unit<1>.dataChannel<7>=mem_control_inst/debug_0_reg<6>
Project.unit<1>.dataChannel<8>=mem_control_inst/debug_0_reg<7>
Project.unit<1>.dataChannel<9>=mem_control_inst/debug_0_reg<8>
Project.unit<1>.dataDepth=512
Project.unit<1>.dataEqualsTrigger=true
Project.unit<1>.dataPortWidth=65
...
Project.unit<1>.triggerChannel<0><0>=mem_control_inst/debug_align
Project.unit<1>.triggerChannel<1><0>=mem_control_inst/debug_0_reg2<0>
Project.unit<1>.triggerChannel<1><10>=mem_control_inst/debug_0_reg2<10>
Project.unit<1>.triggerChannel<1><11>=mem_control_inst/debug_0_reg2<11>
Project.unit<1>.triggerChannel<1><12>=mem_control_inst/debug_0_reg2<12>
Project.unit<1>.triggerChannel<1><13>=mem_control_inst/debug_0_reg2<13>
Project.unit<1>.triggerChannel<1><14>=mem_control_inst/debug_0_reg2<14>
Project.unit<1>.triggerChannel<1><15>=mem_control_inst/debug_0_reg2<15>
Project.unit<1>.triggerChannel<1><1>=mem_control_inst/debug_0_reg2<1>
Project.unit<1>.triggerChannel<1><2>=mem_control_inst/debug_0_reg2<2>
Project.unit<1>.triggerChannel<1><3>=mem_control_inst/debug_0_reg2<3>
Project.unit<1>.triggerChannel<1><4>=mem_control_inst/debug_0_reg2<4>
Project.unit<1>.triggerChannel<1><5>=mem_control_inst/debug_0_reg2<5>
Project.unit<1>.triggerChannel<1><6>=mem_control_inst/debug_0_reg2<6>
Project.unit<1>.triggerChannel<1><7>=mem_control_inst/debug_0_reg2<7>
Project.unit<1>.triggerChannel<1><8>=mem_control_inst/debug_0_reg2<8>
Project.unit<1>.triggerChannel<1><9>=mem_control_inst/debug_0_reg2<9>
Project.unit<1>.triggerChannel<2><0>=mem_control_inst/debug_90_reg2<0>
Project.unit<1>.triggerChannel<2><10>=mem_control_inst/debug_90_reg2<10>
Project.unit<1>.triggerChannel<2><11>=mem_control_inst/debug_90_reg2<11>
Project.unit<1>.triggerChannel<2><12>=mem_control_inst/debug_90_reg2<12>
Project.unit<1>.triggerChannel<2><13>=mem_control_inst/debug_90_reg2<13>
Project.unit<1>.triggerChannel<2><14>=mem_control_inst/debug_90_reg2<14>
Project.unit<1>.triggerChannel<2><15>=mem_control_inst/debug_90_reg2<15>
Project.unit<1>.triggerChannel<2><1>=mem_control_inst/debug_90_reg2<1>
Project.unit<1>.triggerChannel<2><2>=mem_control_inst/debug_90_reg2<2>
Project.unit<1>.triggerChannel<2><3>=mem_control_inst/debug_90_reg2<3>
Project.unit<1>.triggerChannel<2><4>=mem_control_inst/debug_90_reg2<4>
Project.unit<1>.triggerChannel<2><5>=mem_control_inst/debug_90_reg2<5>
Project.unit<1>.triggerChannel<2><6>=mem_control_inst/debug_90_reg2<6>
Project.unit<1>.triggerChannel<2><7>=mem_control_inst/debug_90_reg2<7>
Project.unit<1>.triggerChannel<2><8>=mem_control_inst/debug_90_reg2<8>
Project.unit<1>.triggerChannel<2><9>=mem_control_inst/debug_90_reg2<9>
Project.unit<1>.triggerChannel<3><0>=mem_control_inst/debug_180_reg2<0>
Project.unit<1>.triggerChannel<3><10>=mem_control_inst/debug_180_reg2<10>
Project.unit<1>.triggerChannel<3><11>=mem_control_inst/debug_180_reg2<11>
Project.unit<1>.triggerChannel<3><12>=mem_control_inst/debug_180_reg2<12>
Project.unit<1>.triggerChannel<3><13>=mem_control_inst/debug_180_reg2<13>
Project.unit<1>.triggerChannel<3><14>=mem_control_inst/debug_180_reg2<14>
Project.unit<1>.triggerChannel<3><15>=mem_control_inst/debug_180_reg2<15>
Project.unit<1>.triggerChannel<3><1>=mem_control_inst/debug_180_reg2<1>
Project.unit<1>.triggerChannel<3><2>=mem_control_inst/debug_180_reg2<2>
Project.unit<1>.triggerChannel<3><3>=mem_control_inst/debug_180_reg2<3>
Project.unit<1>.triggerChannel<3><4>=mem_control_inst/debug_180_reg2<4>
Project.unit<1>.triggerChannel<3><5>=mem_control_inst/debug_180_reg2<5>
Project.unit<1>.triggerChannel<3><6>=mem_control_inst/debug_180_reg2<6>
Project.unit<1>.triggerChannel<3><7>=mem_control_inst/debug_180_reg2<7>
Project.unit<1>.triggerChannel<3><8>=mem_control_inst/debug_180_reg2<8>
Project.unit<1>.triggerChannel<3><9>=mem_control_inst/debug_180_reg2<9>
Project.unit<1>.triggerChannel<4><0>=mem_control_inst/debug_270_reg2<0>
Project.unit<1>.triggerChannel<4><10>=mem_control_inst/debug_270_reg2<10>
Project.unit<1>.triggerChannel<4><11>=mem_control_inst/debug_270_reg2<11>
Project.unit<1>.triggerChannel<4><12>=mem_control_inst/debug_270_reg2<12>
Project.unit<1>.triggerChannel<4><13>=mem_control_inst/debug_270_reg2<13>
Project.unit<1>.triggerChannel<4><14>=mem_control_inst/debug_270_reg2<14>
Project.unit<1>.triggerChannel<4><15>=mem_control_inst/debug_270_reg2<15>
Project.unit<1>.triggerChannel<4><1>=mem_control_inst/debug_270_reg2<1>
Project.unit<1>.triggerChannel<4><2>=mem_control_inst/debug_270_reg2<2>
Project.unit<1>.triggerChannel<4><3>=mem_control_inst/debug_270_reg2<3>
Project.unit<1>.triggerChannel<4><4>=mem_control_inst/debug_270_reg2<4>
Project.unit<1>.triggerChannel<4><5>=mem_control_inst/debug_270_reg2<5>
Project.unit<1>.triggerChannel<4><6>=mem_control_inst/debug_270_reg2<6>
Project.unit<1>.triggerChannel<4><7>=mem_control_inst/debug_270_reg2<7>
Project.unit<1>.triggerChannel<4><8>=mem_control_inst/debug_270_reg2<8>
Project.unit<1>.triggerChannel<4><9>=mem_control_inst/debug_270_reg2<9>
...
Project.unit<1>.triggerPortWidth<1>=16
Project.unit<1>.triggerPortWidth<2>=16
Project.unit<1>.triggerPortWidth<3>=16
Project.unit<1>.triggerPortWidth<4>=16
